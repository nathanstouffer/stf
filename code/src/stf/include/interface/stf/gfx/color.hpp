...
public:
    ...
    {
        return rgba(from_hex(hex_rgba, 24), from_hex(hex_rgba, 16), from_hex(hex_rgba, 8), from_hex(hex_rgba, 0));
    }
    ...
    {
        return rgba(from_hex(hex_abgr, 0), from_hex(hex_abgr, 8), from_hex(hex_abgr, 16), from_hex(hex_abgr, 24));
    }
    ...
    {
        return rgba(from_hex(hex_argb, 16), from_hex(hex_argb, 8), from_hex(hex_argb, 0), from_hex(hex_argb, 24));
    }
};
