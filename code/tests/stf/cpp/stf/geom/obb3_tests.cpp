...
TEST(obb3, fit)
{
    std::vector<scaffolding::geom::obb::fit<float, 3>> tests = {
        {stf::math::rotate_z(stff::constants::quarter_pi).prefix() *
             stf::math::rotate_y(-stff::constants::quarter_pi).prefix(),
...
TEST(obb3, intersect)
{
    ...
    std::vector<scaffolding::geom::obb::intersect<float, 3>> tests = {
        {stff::obb3(stff::aabb3(stff::vec3(0), stff::vec3(1))), stff::obb3(stff::aabb3(stff::vec3(0), stff::vec3(1))),
         true},
        {stff::obb3(stff::aabb3(stff::vec3(0), stff::vec3(1))), stff::obb3(stff::aabb3(stff::vec3(1), stff::vec3(2))),
         true},
        {stff::obb3(stff::aabb3(stff::vec3(0), stff::vec3(1))), stff::obb3(stff::aabb3(stff::vec3(2), stff::vec3(2))),
         false},
        {stff::obb3(stff::aabb3(stff::vec3(0), stff::vec3(1))), stff::obb3(stff::aabb3(stff::vec3(2), stff::vec3(3))),
         false},
    };
    ...
    {
        {
            ...
            tests.push_back({stff::obb3(stff::aabb3(stff::vec3(0), stff::vec3(1))),
                             stff::obb3(center, rotation.prefix(), stff::vec3(1)), true});
        }
        {
            stff::vec3 center(5);
            float quarter_pi = stff::constants::quarter_pi;
            ...
            tests.push_back({stff::obb3(stff::aabb3(stff::vec3(0), stff::vec3(1))),
                             stff::obb3(center, rotation.prefix(), stff::vec3(1, half_extent, half_extent)), false});
        }
        {
            stff::vec3 center0(0);
            stff::mtx4 rotation0 =
                stf::math::rotate_x(stff::constants::half_pi) * stf::math::rotate_z(stff::constants::quarter_pi);
            ...
            tests.push_back(
                {box0, stff::obb3(center1 - stff::vec3(0, 0, 0.001f), rotation1.prefix(), stff::vec3(1)), true});
            tests.push_back(
                {box0, stff::obb3(center1 + stff::vec3(0, 0, 0.001f), rotation1.prefix(), stff::vec3(1)), false});
        }
    }
