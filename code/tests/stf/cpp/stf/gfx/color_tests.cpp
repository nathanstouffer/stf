...
TEST(rgba, equality)
{
    std::vector<scaffolding::gfx::color::rgba_equality> tests = {
        {stf::gfx::rgba(), stf::gfx::rgba(), true},    {stf::gfx::rgba(0), stf::gfx::rgba(0), true},
        {stf::gfx::rgba(1), stf::gfx::rgba(1), true},  {stf::gfx::rgba(2), stf::gfx::rgba(2), true},
        {stf::gfx::rgba(), stf::gfx::rgba(1), false},  {stf::gfx::rgba(1), stf::gfx::rgba(2), false},
        {stf::gfx::rgba(2), stf::gfx::rgba(3), false}, {stf::gfx::rgba(3), stf::gfx::rgba(4), false},
    };
