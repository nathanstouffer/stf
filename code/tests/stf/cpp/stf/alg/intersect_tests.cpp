...
namespace stf::alg
{
    ...
    TEST(intersect, ray_with_plane)
    {
        std::vector<scaffolding::alg::intersect::ray_with_plane<float>> tests =
        {
            ...
            { stff::ray3(stff::vec3(0, 0, 1), stff::vec3(1, 0, 0)), stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), std::nullopt },
            { stff::ray3(stff::vec3(-1, 0, 0), stff::vec3(0, 0, 1)), stff::plane(stff::vec3(), stff::vec3(1, 0, 0)), std::nullopt },
            // ray is pointing towards plane
            { stff::ray3(stff::vec3(0, 0, 10), stff::vec3(1, 1, -1)), stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), stff::vec3(10, 10, 0) },
            { stff::ray3(stff::vec3(0, 0, 100), stff::vec3(0, 0, -1)), stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), stff::vec3() },
