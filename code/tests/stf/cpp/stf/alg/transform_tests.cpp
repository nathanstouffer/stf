...
namespace alg {
    ...
    // {
    //     std::vector<scaffolding::transform::orbit_camera<float>> tests = 
    //     {
    //         {  },
    //     };

    //     for (scaffolding::transform::orbit_camera<float> const& test : tests) { scaffolding::transform::verify(test); }
    // }
