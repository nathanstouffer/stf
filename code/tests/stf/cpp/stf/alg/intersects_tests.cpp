...
TEST(intersects, segment_with_segment)
{
    std::vector<scaffolding::alg::intersects::segment_with_segment<float>> tests = {
        ...
        {stff::segment2(stff::vec2(0), stff::vec2(1)), stff::segment2(stff::vec2(0), stff::vec2(1)),
         true},
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(0.5), stff::vec2(1)), true},
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(0), stff::vec2(0.5f)), true},
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(0.25f), stff::vec2(0.75f)), true},
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(-1), stff::vec2(2)), true},
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(0.5f), stff::vec2(2)), true},
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(-2), stff::vec2(0.5f)), true},
        // colinear segments that do not intersect
        {stff::segment2(stff::vec2(0), stff::vec2(1)), stff::segment2(stff::vec2(2), stff::vec2(4)),
         false},
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(-2), stff::vec2(-4)), false},
        // non colinear segments that intersect
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(0, 1), stff::vec2(1, 0)), true},
        {stff::segment2(stff::vec2(4), stff::vec2(8, 0)),
         stff::segment2(stff::vec2(6, 2), stff::vec2(1, 0)), true},
        {stff::segment2(stff::vec2(4), stff::vec2(8, 0)),
         stff::segment2(stff::vec2(0, 2), stff::vec2(10, 2)), true},
        {stff::segment2(stff::vec2(0), stff::vec2(5)),
         stff::segment2(stff::vec2(0, -2), stff::vec2(0, 2)), true},
        // non colinear segments that do not intersect
        {stff::segment2(stff::vec2(0), stff::vec2(1)),
         stff::segment2(stff::vec2(0, -1), stff::vec2(1, 0)), false},
        {stff::segment2(stff::vec2(4), stff::vec2(8, 0)),
         stff::segment2(stff::vec2(5.99999f, 2), stff::vec2(1, 0)), false},
        {stff::segment2(stff::vec2(0), stff::vec2(5)),
         stff::segment2(stff::vec2(-2, 0), stff::vec2(2, -2)), false},
        {stff::segment2(stff::vec2(0), stff::vec2(5)),
         stff::segment2(stff::vec2(-0.00001f, -2), stff::vec2(0, 2)), false},
    };
...
TEST(intersects, polyline_with_aabb)
{
    ...
    std::vector<scaffolding::alg::intersects::polyline_with_aabb<float>> tests = {
        ...
        {stff::polyline2(
             {stff::vec2(-0.00001f), stff::vec2(-0.00001f, 10.00001f), stff::vec2(10.00001f)}),
         box, false},
    };
    scaffolding::verify(tests);
}
...
TEST(intersects, polygon_with_aabb)
{
    ...
    std::vector<scaffolding::alg::intersects::polygon_with_aabb<float>> tests = {
        ...
        {stff::polygon(
             {stff::vec2(-1), stff::vec2(-1, 11), stff::vec2(12, 15), stff::vec2(15, -5)}),
         box, true},
        ...
        {stff::polygon({stff::vec2(-11, 10), stff::vec2(-0.000001f, 10), stff::vec2(-0.000001f),
                        stff::vec2(10, -0.000001f), stff::vec2(10, -11)}),
         box, false},
    };
    scaffolding::verify(tests);
}
...
TEST(intersects, polygon_with_segment)
{
    std::vector<scaffolding::alg::intersects::polygon_with_segment<float>> tests = {
        ...
        {stff::polygon({stff::vec2(0), stff::vec2(5), stff::vec2(5, 0)}),
         stff::segment2(stff::vec2(2, 1), stff::vec2(4, 3)), true},
        {stff::polygon(
             {stff::vec2(-1), stff::vec2(-1, 11), stff::vec2(12, 15), stff::vec2(15, -5)}),
         stff::segment2(stff::vec2(10, 2), stff::vec2(3, 8)), true},
        // segment crossing polygon boundary
        {stff::polygon({stff::vec2(-1), stff::vec2(5), stff::vec2(6, -1)}),
         stff::segment2(stff::vec2(0, 4), stff::vec2(3, 2)), true},
        {stff::polygon({stff::vec2(-1, 5), stff::vec2(5), stff::vec2(4, 2)}),
         stff::segment2(stff::vec2(3, 8), stff::vec2(3, 4)), true},
        // segment touching only polygon boundary
        {stff::polygon({stff::vec2(-1), stff::vec2(0), stff::vec2(0, -1)}),
         stff::segment2(stff::vec2(-1), stff::vec2(0)), true},
        {stff::polygon({stff::vec2(0), stff::vec2(10, 0), stff::vec2(5, -5)}),
         stff::segment2(stff::vec2(5, 0), stff::vec2(8, 0)), true},
        // segments outside polygon
        {stff::polygon({stff::vec2(-1), stff::vec2(-5), stff::vec2(-5, 0)}),
         stff::segment2(stff::vec2(2), stff::vec2(9, 0)), false},
        {stff::polygon({stff::vec2(-1), stff::vec2(-5), stff::vec2(-5, 0)}),
         stff::segment2(stff::vec2(-4, -5), stff::vec2(-2, -3)), false},
    };
    scaffolding::verify(tests);
}
...
TEST(intersects, polygon_with_polyline)
{
    std::vector<scaffolding::alg::intersects::polygon_with_polyline<float>> tests = {
        ...
        {stff::polygon({stff::vec2(0), stff::vec2(5), stff::vec2(5, 0)}),
         stff::polyline2({stff::vec2(2, 1), stff::vec2(4, 3)}), true},
        {stff::polygon(
             {stff::vec2(-1), stff::vec2(-1, 11), stff::vec2(12, 15), stff::vec2(15, -5)}),
         stff::polyline2({stff::vec2(10, 2), stff::vec2(3, 8)}), true},
        // polyline crossing polygon boundary
        {stff::polygon({stff::vec2(-1), stff::vec2(5), stff::vec2(6, -1)}),
         stff::polyline2({stff::vec2(0, 4), stff::vec2(3, 2)}), true},
        {stff::polygon({stff::vec2(-1, 5), stff::vec2(5), stff::vec2(4, 2)}),
         stff::polyline2({stff::vec2(3, 8), stff::vec2(3, 4)}), true},
        // polyline touching only polygon boundary
        {stff::polygon({stff::vec2(-1), stff::vec2(0), stff::vec2(0, -1)}),
         stff::polyline2({stff::vec2(-1), stff::vec2(0)}), true},
        {stff::polygon({stff::vec2(0), stff::vec2(10, 0), stff::vec2(5, -5)}),
         stff::polyline2({stff::vec2(5, 0), stff::vec2(8, 0)}), true},
        // polyline outside polygon
        {stff::polygon({stff::vec2(-1), stff::vec2(-5), stff::vec2(-5, 0)}),
         stff::polyline2({stff::vec2(2), stff::vec2(9, 0)}), false},
        {stff::polygon({stff::vec2(-1), stff::vec2(-5), stff::vec2(-5, 0)}),
         stff::polyline2({stff::vec2(-4, -5), stff::vec2(-2, -3)}), false},
    };
    scaffolding::verify(tests);
}
...
TEST(intersects, ray_with_plane)
{
    std::vector<scaffolding::alg::intersects::ray_with_plane<float>> tests = {
        ...
        {stff::ray3(stff::vec3(), stff::vec3(1, 0, 0)),
         stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), true},
        {stff::ray3(stff::vec3(), stff::vec3(1, 1, 0)),
         stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), true},
        {stff::ray3(stff::vec3(), stff::vec3(0, 0, 1)),
         stff::plane(stff::vec3(), stff::vec3(1, 0, 0)), true},
        // ray that is parallel to plane
        {stff::ray3(stff::vec3(0, 0, 1), stff::vec3(1, 0, 0)),
         stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), false},
        {stff::ray3(stff::vec3(-1, 0, 0), stff::vec3(0, 0, 1)),
         stff::plane(stff::vec3(), stff::vec3(1, 0, 0)), false},
        // ray is pointing towards plane
        {stff::ray3(stff::vec3(0, 0, 10), stff::vec3(1, 1, -1)),
         stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), true},
        {stff::ray3(stff::vec3(0, 0, 100), stff::vec3(0, 0, -1)),
         stff::plane(stff::vec3(), stff::vec3(0, 0, 1)), true},
