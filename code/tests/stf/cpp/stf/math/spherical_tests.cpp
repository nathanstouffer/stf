...
TEST(spherical, unit_vector)
{
    std::vector<scaffolding::math::spherical::unit_vec2<float>> tests = {
        ...
        {stff::constants::quarter_pi,
         stff::vec2(stff::constants::sqrt_two_inv, stff::constants::sqrt_two_inv)},
    };
    scaffolding::verify(tests);
}
...
TEST(spherical, to_euclidean)
{
    std::vector<scaffolding::math::spherical::to_euclidean<float>> tests = {
        ...
        {stff::constants::sqrt_two, stff::constants::pi, stff::constants::quarter_pi,
         stff::vec3(-1, 0, 1)},
        {stff::constants::sqrt_two, stff::constants::pi, 3 * stff::constants::quarter_pi,
         stff::vec3(-1, 0, -1)},
    };
    scaffolding::verify(tests);
}
