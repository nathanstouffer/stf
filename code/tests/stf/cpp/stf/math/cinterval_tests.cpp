...
namespace stf::math
{
    ...
    TEST(cinterval, contains_point)
    {
        std::vector<scaffolding::cinterval::contains_point<float>> tests =
        {
            ...
            { stff::cinterval(2, 6), boundary_types::CLOSED, 1.999999, false },
            { stff::cinterval(2, 6), boundary_types::CLOSED, 6.000001, false },
            ...
            { stff::cinterval(2, 6), boundary_types::OPEN, 1.999999, false },
            { stff::cinterval(2, 6), boundary_types::OPEN, 6.000001, false },
